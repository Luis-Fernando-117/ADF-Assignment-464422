...
rm(emotion.score)
emotion.score <- left_join(term.frequency.obrador.followers, 
                                         spanish_emotions, by = "key")

emotion.score <- na.omit(emotion.score)

emotion.score <- emotion.score %>% group_by(emotion) %>% summarise(tot_freq = sum())
