...
Bind alll the tweets texts into a single df
```{r}
...
Make a single histgram for the distribition of the tweets of all presidents 
```{r}
...
Do the same but for the presidents tweets 
