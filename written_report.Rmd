...
Given that the tweets we will analyze are in spanish language, we will use a publicly available Natural Language Processing (NLP) package for R, called UDPipe. This package wi
